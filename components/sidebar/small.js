...
export default function Sidebar({ className = "" }) {
  ...
  return (
    <div
      className={`sidebar ${
        open ? "sidebar-full" : ""
      } flex flex-col items-center w-60 h-full overflow-y-auto ${className}`}
    >
      <div className="w-full px-2">
        <div className="flex flex-col items-center w-full">
          <span
            className="flex items-center w-full h-12 px-3 rounded hover:bg-neutral-focus cursor-pointer"
