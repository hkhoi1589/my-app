  ...
  return (
    <div>
      <div className="fixed inset-0 blur-[86px] flex items-center justify-center">
        <div
          id="paral-1"
          className="bg-sky-500 opacity-40 w-72 h-72 rounded-full"
          style={{
        ...
        <div
          id="paral-2"
          className="bg-green-500 opacity-40 w-96 h-96 rounded-full will-change-transform transform-gpu"
          style={{
        ...
        <div
          id="paral-3"
          className="bg-yellow-500 opacity-40 w-56 h-56 rounded-full"
          style={{
            transform: "translate3d(0px, -60px, 0px)",
          }}
        ></div>
